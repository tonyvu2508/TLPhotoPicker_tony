...
protocol TLPhotoCollectionViewCellDelegate: AnyObject {
...
open class TLPhotoCollectionViewCell: UICollectionViewCell {
    ...
    @IBOutlet open var selectedCircle: UIButton?
    ...
    weak var delegate: TLPhotoCollectionViewCellDelegate?
...
//        print("deinit TLPhotoCollectionViewCell")
    ...
    @IBAction func touchSelectedCircle(_ sender: Any) {
        delegate?.didTouchSelectedCircle(cell: self)
    }
}
